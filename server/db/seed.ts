...
async function seed() {
  ...
  const artworkData = [
    ...
    { id: 'red-shift', title: 'Red Shift', category: 'anime', medium: 'Midjourney', description: 'A crimson motorcycle tears through neon streets, rider leaning into impossible speed — velocity rendered as light trails and adrenaline.', src: '/images/artworks/red-shift.webp', aspect: 'wide', year: 2025, sortOrder: 24, dominantColor: '#c43030', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'night-patrol', title: 'Night Patrol', category: 'anime', medium: 'Midjourney', description: 'Helmeted riders crowd a dark alley between towering buildings — urban tension compressed into a single frame.', src: '/images/artworks/night-patrol.webp', aspect: 'square', year: 2025, sortOrder: 25, dominantColor: '#2a3a6a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'the-infiltrator', title: 'The Infiltrator', category: 'anime', medium: 'Midjourney', description: 'A black-suited figure moves through industrial corridors, weapon drawn — paranoia and purpose given form.', src: '/images/artworks/the-infiltrator.webp', aspect: 'square', year: 2025, sortOrder: 26, dominantColor: '#4a4a4a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'the-operator', title: 'The Operator', category: 'anime', medium: 'Midjourney', description: 'A small figure hunches before a wall of glowing screens in darkness — the weight of omniscience, the loneliness of control.', src: '/images/artworks/the-operator.webp', aspect: 'square', year: 2025, sortOrder: 27, dominantColor: '#2a3a5a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'the-submersible', title: 'The Submersible', category: 'anime', medium: 'Midjourney', description: 'A spherical fish-shaped vessel with a tiny pilot peering out — wonder compressed into a machine, adventure made adorable.', src: '/images/artworks/the-submersible.webp', aspect: 'square', year: 2025, sortOrder: 28, dominantColor: '#d4a040', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'the-scouts', title: 'The Scouts', category: 'anime', medium: 'Midjourney', description: 'A bug-eyed yellow vehicle and its tiny green companion survey the clouds from a cliff edge — exploration at the scale of toys.', src: '/images/artworks/the-scouts.webp', aspect: 'wide', year: 2025, sortOrder: 29, dominantColor: '#c4a040', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'city-of-lights', title: 'City of Lights', category: 'anime', medium: 'Midjourney', description: 'A small figure stands atop a building overlooking a vast illuminated metropolis at twilight — the city as organism, witnessed from above.', src: '/images/artworks/city-of-lights.webp', aspect: 'wide', year: 2025, sortOrder: 30, dominantColor: '#4a5a7a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    ...
    { id: 'the-deep', title: 'The Deep', category: 'sci-fi', medium: 'Midjourney', description: 'A figure stands beneath a massive organic cavern of teal and shadow — the alien rendered as architecture, scale as terror.', src: '/images/artworks/the-deep.webp', aspect: 'wide', year: 2025, sortOrder: 35, dominantColor: '#2a5a5a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'bioluminescence', title: 'Bioluminescence', category: 'sci-fi', medium: 'Midjourney', description: 'An underwater world glows with scattered lights as a tiny explorer walks its floor — the ocean reimagined as cathedral.', src: '/images/artworks/bioluminescence.webp', aspect: 'wide', year: 2025, sortOrder: 36, dominantColor: '#2a5a5a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
    { id: 'leviathan', title: 'Leviathan', category: 'sci-fi', medium: 'Midjourney', description: 'A diver with a single light encounters the mouth of something vast and dark — the sublime terror of being small in an enormous world.', src: '/images/artworks/leviathan.webp', aspect: 'wide', year: 2025, sortOrder: 37, dominantColor: '#2a4a5a', rawPrompt: null, mjVersion: null, refinementNotes: null, published: true },
