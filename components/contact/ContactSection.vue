  ...
  <section id="contact" ref="sectionEl" class="section relative overflow-hidden section-bleed-top">
    ...
    <div class="max-w-5xl mx-auto relative z-10">
      ...
      <p class="font-body text-sm text-lavender-300 mt-8 opacity-0" ref="emailFallbackEl">
        ...
        <a href="mailto:brianlapinskiart@gmail.com" class="text-lavender-300 hover:text-accent-red transition-colors duration-200 underline underline-offset-4">
          brianlapinskiart@gmail.com
        </a>
      </p>
    </div>
